...
class CreditcardsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'card_number' => ['type' => 'varbinary', 'length' => 256, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'name' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'deadline' => ['type' => 'string', 'length' => 5, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'deadline' => 'Lorem ipsum dolor sit amet',
                'is_deleted' => 1,
                'created_at' => '2021-01-07 16:30:54',
                'updated_at' => '2021-01-07 16:30:54',
            ],
        ];
        parent::init();
    }
