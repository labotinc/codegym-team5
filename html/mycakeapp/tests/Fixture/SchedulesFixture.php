...
class SchedulesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'theater_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'movie_id' => 1,
                'theater_id' => 1,
                'start_date' => '2021-01-07 16:32:09',
                'is_deleted' => 1,
                'created_at' => '2021-01-07 16:32:09',
                'updated_at' => '2021-01-07 16:32:09',
            ],
        ];
        parent::init();
    }
