...
/**
 * SeatReservationsFixture
 */
class SeatReservationsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public function init()
    {
        $this->records = [
            [
                'member_id' => 1,
                'schedule_id' => 1,
                'column_number' => '2ac1e5b2-96b5-490e-b97f-d6a683bed976',
                'record_number' => 'b3af7712-d1fa-4a9a-bf19-4c8476fe4515',
                'is_cancelled' => 1,
                'created_at' => '2021-01-07 16:32:49',
                'updated_at' => '2021-01-07 16:32:49',
            ],
        ];
        parent::init();
    }
