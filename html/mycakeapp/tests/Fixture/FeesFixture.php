...
class FeesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'fee' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'fee' => 1,
                'started_at' => '2021-01-07 16:34:07',
                'finished_at' => '2021-01-07 16:34:07',
                'is_deleted' => 1,
                'created_at' => '2021-01-07 16:34:07',
                'updated_at' => '2021-01-07 16:34:07',
            ],
        ];
        parent::init();
    }
