...
class PaymentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'column_number' => ['type' => 'string', 'length' => 2, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'record_number' => ['type' => 'string', 'length' => 2, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'purchase_price' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['member_id', 'schedule_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'schedule_id' => 1,
                'creditcard_id' => 1,
                'column_number' => '1146acbe-5f35-4fc3-adda-93d2aeaeed98',
                'record_number' => '2a48fe82-7aaa-49ab-b220-da41b9066e64',
                'purchase_price' => 1,
                'is_cancelled' => 1,
                'created_at' => '2021-01-07 16:33:31',
                'updated_at' => '2021-01-07 16:33:31',
            ],
        ];
        parent::init();
    }
