 ...
 * PointRatesFixture
 */
class PointRatesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'point_rate' => ['type' => 'decimal', 'length' => 6, 'precision' => 3, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'point_rate' => 1.5,
                'started_at' => '2021-01-07 16:34:01',
                'finished_at' => '2021-01-07 16:34:01',
                'is_deleted' => 1,
                'created_at' => '2021-01-07 16:34:01',
                'updated_at' => '2021-01-07 16:34:01',
            ],
        ];
        parent::init();
    }
