...
class MembersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'total_point' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'is_deleted' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'is_provisional' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_deleted' => 1,
                'is_provisional' => 1,
                'created_at' => '2021-01-07 16:30:31',
                'updated_at' => '2021-01-07 16:30:31',
            ],
        ];
        parent::init();
    }
